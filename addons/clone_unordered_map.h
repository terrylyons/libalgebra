...
#undef BOOLOP
    ...
    friend void swap(const CLONE_UNORDERED_MAP<T...> &lhs, const CLONE_UNORDERED_MAP<T...> &rhs) {
        CLONE_UNORDERED_MAP<T...>::my_base::swap(static_cast<const CLONE_UNORDERED_MAP<T...>::my_base &>(lhs),
                                                 static_cast<const CLONE_UNORDERED_MAP<T...>::my_base &>(rhs));
    }
