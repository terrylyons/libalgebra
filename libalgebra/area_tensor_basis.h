...
corresponds to the anti-symmetrised half-shuffle or area product of the two keys given as arguments.
...
*/
template <DEG n_letters, DEG max_degree> class area_tensor_basis : public alg::tensor_basis<n_letters, max_degree>,
...
namespace vectors {
	...
	struct vector_type_selector<area_tensor_basis<n_letters, max_depth>, Field>
	{
		typedef area_tensor_basis<n_letters, max_depth> BASIS;
