...
enum basis_product_trait { Without_Degree, With_Degree, No_Product };
...
/// No_Product.
template <basis_product_trait trait = Without_Degree, DEG no_letters = 0, DEG max_degree = 0> struct basis_traits
{
