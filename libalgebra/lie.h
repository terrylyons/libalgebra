...
template <typename Coeff> class lie_multiplication
{
    ...
    template <typename Lie> static Lie _prod(typename Lie::KEY const &k1, typename Lie::KEY const &k2)
    {
        typedef Lie lie_t;
    ...
    template <typename Lie> static std::map<typename Lie::BASIS::PARENT, Lie> prime_prod_cache_table()
    {
    ...
    template <typename Lie, typename Transform> class index_operator
    {
    ...
    template <typename Lie, typename Transform> class key_operator
    {
        Transform m_transform;
    ...
    public:
        ...
        template <typename... Args> explicit key_operator(Args &&... args) : m_transform(std::forward<Args>(args)...) {}
