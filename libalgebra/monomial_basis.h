...
*/
template <DEG n_letters, DEG max_degree>
class free_monomial_basis : public monomial_basis<SCA,
                                                  n_letters,
                                                  max_degree> {
public:
    /// The monomial_basis type.
    typedef monomial_basis<n_letters,
                           max_degree> PBASIS;
...
public:
    ...
    */
    ...
    inline friend std::ostream &operator<<(std::ostream &os, const std::pair<free_monomial_basis *,
                                                                             KEY> &t) {
