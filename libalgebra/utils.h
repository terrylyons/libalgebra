...
public:
    ...
    public:
        ...
        TENSOR operator()(const alg::free_tensor<Coeff2,
                                                 n_letters1,
                                                 max_degree1> &in) const {
            typedef alg::free_tensor<Coeff2,
                                     n_letters1,
                                     max_degree1> TENSORIN;
