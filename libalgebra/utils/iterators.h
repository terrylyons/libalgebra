...
template <typename Vector,
        typename Iterator>
inline typename boost::enable_if<typename boost::mpl::and_<boost::is_same<typename boost::remove_cv<typename std::iterator_traits<Iterator>::value_type::first_type>::type,
                                                                          typename Vector::KEY>,
                                                           boost::is_same<typename boost::remove_cv<typename std::iterator_traits<Iterator>::value_type::second_type>::type,
...
inline typename boost::enable_if<typename boost::mpl::and_<boost::is_same<typename ValueType::first_type,
                                                                          const typename Vector::KEY>,
                                                           boost::is_same<typename ValueType::second_type,
                                                                          typename Vector::SCALAR> >::type,
                                 typename copy_constness<Reference,
                                                         typename ValueType::second_type>::type &>::type
value(Iterator &it) {
    return it->second;
}
